...
extern "C" {
    ...
    pub fn trace_4(a: &JsValue, b: &JsValue, c: &JsValue, d: &JsValue);

    #[wasm_bindgen(js_namespace = console, js_name = "debug")]
    pub fn debug_4(a: &JsValue, b: &JsValue, c: &JsValue, d: &JsValue);

    #[wasm_bindgen(js_namespace = console, js_name = "info")]
    pub fn info_4(a: &JsValue, b: &JsValue, c: &JsValue, d: &JsValue);

    #[wasm_bindgen(js_namespace = console, js_name = "warn")]
    pub fn warn_4(a: &JsValue, b: &JsValue, c: &JsValue, d: &JsValue);

    #[wasm_bindgen(js_namespace = console, js_name = "error")]
    pub fn error_4(a: &JsValue, b: &JsValue, c: &JsValue, d: &JsValue);
}
...
impl tracing::Level {
    ...
    fn web_logger_4(&self) -> fn(&JsValue, &JsValue, &JsValue, &JsValue) {
        match *self {
            tracing::Level::TRACE => trace_4,
            tracing::Level::DEBUG => debug_4,
            tracing::Level::INFO => info_4,
            tracing::Level::WARN => warn_4,
            tracing::Level::ERROR => error_4,
        }
    }
